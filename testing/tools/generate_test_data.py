...
def generate_user_data():
    ...
    companies = ["Acme Corp", "Tech Solutions", "Data Systems", "Cloud Innovations", "Security First"]
...
def generate_compliance_violations():
    ...
    for _ in range(random.randint(3, 8)):
        violations.append({
            ...
            "detected_at": (datetime.utcnow() - timedelta(hours=random.randint(1, 72))).isoformat(),
...
def save_test_data(filename="test_data.json"):
    ...
    test_data = {
        ...
        "sample_service_accounts": [
            generate_service_account() for _ in range(5)
        ],
        "sample_users": [
            generate_user_data() for _ in range(10)
        ],
