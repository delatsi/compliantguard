...
echo "🔐 Creating SSL certificate for compliantguard.delatsi.com"

# Request certificate
CERT_ARN=$(aws acm request-certificate \
    --domain-name "compliantguard.delatsi.com" \
...
echo ""
echo "2. Add the CNAME records to your delatsi.com DNS zone"
echo ""
