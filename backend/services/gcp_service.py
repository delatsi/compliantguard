...
class GCPAssetService:
    ...
    async def get_project_assets(self, project_id: str) -> Dict[str, Any]:
        ...
        if not self.client:
            raise Exception("GCP client not initialized. Check GOOGLE_APPLICATION_CREDENTIALS.")
    ...
    async def get_project_storage_buckets(self, project_id: str) -> List[Dict[str, Any]]:
