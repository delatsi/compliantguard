...
async def upload_gcp_credentials_file(
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                status_code=400, detail=f"Invalid JSON file format: {str(e)}"
            )
        ...
        print(
            f"✅ Valid service account for: {service_account_json.get('client_email')}"
        )
        ...
        return {
            ...
            "service_account_email": service_account_json.get(
