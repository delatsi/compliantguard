...
class ComplianceReport(BaseModel):
    ...
    violations: List[Violation] = Field(default=[], description="List of violations found")
    ...
    medium_violations: int = Field(0, description="Number of medium severity violations")
...
class ViolationSummary(BaseModel):
    ...
    violations_by_severity: Dict[ViolationSeverity, int] = Field(default={}, description="Violations grouped by severity")
    violations_by_type: Dict[ViolationType, int] = Field(default={}, description="Violations grouped by type")
...
class DashboardData(BaseModel):
    ...
    overall_compliance_score: float = Field(0.0, description="Overall compliance score across all projects")
    violation_summary: ViolationSummary = Field(default=ViolationSummary(), description="Summary of violations")
...
class ScanRequest(BaseModel):
    ...
    include_policies: List[str] = Field(default=[], description="Specific policies to include")
    exclude_policies: List[str] = Field(default=[], description="Specific policies to exclude")