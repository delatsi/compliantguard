...
class ChurnAnalytics(BaseModel):
    ...
    # Churn trends
    churn_trend_6_months: List[Dict[str, Any]]  # [{"month": "Jan", "churn_rate": 3.2, "churned_customers": 12}]
    churn_by_plan: Dict[str, float]  # {"starter": 5.2, "professional": 2.8, "enterprise": 1.1}
    churn_by_industry: Dict[str, float]
    churn_by_customer_age: Dict[str, float]  # {"0-3_months": 15.5, "3-6_months": 8.2, etc.}
    
    # Churn reasons and patterns
    churn_reasons: List[Dict[str, Any]]  # [{"reason": "Price", "percentage": 35.2, "count": 23}]
    voluntary_vs_involuntary: Dict[str, float]  # {"voluntary": 78.5, "involuntary": 21.5}
    
    # Early warning indicators
    at_risk_customers: Dict[str, int]  # {"high_risk": 45, "medium_risk": 123, "low_risk": 234}
...
class CustomerMetrics(BaseModel):
    ...
    expansion_revenue_rate: float  # Percentage of revenue from existing customers upgrading
